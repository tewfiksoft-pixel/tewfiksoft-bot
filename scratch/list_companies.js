...
if (plain) {
    ...
    console.log('Companies Count:', db.hr_companies ? db.hr_companies.length : 0);
    if (db.hr_companies && db.hr_companies.length > 0) {
        console.log('All Companies:', db.hr_companies);
    }
}
