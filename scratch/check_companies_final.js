...
if (plain) {
    ...
    if ('hr_companies' in db) {
        console.log('Type of hr_companies:', typeof db.hr_companies);
        console.log('Value of hr_companies:', db.hr_companies);
    } else {
        console.log('hr_companies NOT in db');
    }
}
